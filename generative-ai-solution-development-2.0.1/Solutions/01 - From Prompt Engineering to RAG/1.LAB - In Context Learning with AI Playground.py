...
# MAGIC
# MAGIC
# MAGIC **🚨Note:** The level of hallucination depends on the LLM used. For this demo, use **`Mixtral-8x7B`** to see the model's hallucination. Also, you have to clear the Playground history if you don’t want it in “chat” (conversation) mode.
