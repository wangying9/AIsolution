...
# MAGIC
# MAGIC ![playground](files/images/generative-ai-solution-development-2.0.1/playground.png)
# MAGIC
...
# MAGIC
# MAGIC **📌 IMPORTANT:** The level of hallucination depends on the LLM used. For this demo, use **`Mixtral-8x7B`** to see the model's hallucination. If you use Meta's **`llama-3`**, you will see that the model hallucinates much less.
# MAGIC
# MAGIC
